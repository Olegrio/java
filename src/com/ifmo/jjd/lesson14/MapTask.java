...
public class MapTask {
    public static void main(String[] args) {
        ...
        String city = "Тверь";
        System.out.println(Customer.getLoginForCity(firstTaskMap, city));
        ...
        System.out.println(Customer.getCountEqualWords(words));
        ...
        System.out.println(Customer.getCustomerForAge(customerMap, 20, 30));
        ...
        // System.out.println(TextUtils.getCountContains(text, "uncover"));
        // System.out.println(TextUtils.getCountContainsWords(text));
        // TextUtils.wordsMostOftenFount(text);
        TextUtils.getCountLetterEquals(text);
    }
